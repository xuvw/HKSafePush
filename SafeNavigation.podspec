#
#  Be sure to run `pod spec lint SafeNavigation.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "SafeNavigation/**/UINavigationController+HKExts.{h,m}", "SafeNavigation/**/UIViewController+HKSafeExts.{h,m}"
